...
- [Getting started](${SITE_INFO.url}/docs): Installation, registry, and MCP setup guides.
...
${docs.map((item) => `- [${item.metadata.title}](${SITE_INFO.url}/docs/${item.slug}.mdx): ${item.metadata.description}`).join("\n")}
